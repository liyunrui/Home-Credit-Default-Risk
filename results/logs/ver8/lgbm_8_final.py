...
feature_graveyard = [
    #rm 9 importance / null_importance <= 1
    ...
    # rm10 1 < importance / null_importance <= 2
    ...
    # rm11 2 < importance / null_importance <= 3
    ...
    # rm12 3 < importance / null_importance <= 4
    ...
    # rm13 4 < importance / null_importance <= 5
    ...
    # rm14  5 < importance / null_importance <= 6
    ...
    # rm 15 6 < importance / null_importance <= 10
    ...
    # # rm16 10 < importance / null_importance <= 14
    ...
    # 'BURO_AMT_CREDIT_SUM_MAX', 'POS_SK_DPD_DEF_MAX', 'APPROVED_TIME_DECAYED_HUMAN_EVAL_SUM', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_SUM',
    # 'INSTAL_PAYMENT_DIFF_SUM', 'INSTAL_PAYMENT_DIFF_MAX', 'PREV_NAME_GOODS_CATEGORY_XNA_MEAN', 'PREV_APP_CREDIT_PERC_MAX',
    # 'REFUSED_TIME_DECAYED_HUMAN_EVAL_SUM', 'PREV_CODE_REJECT_REASON_SCO_MEAN', 'LIVINGAREA_MEDI', 'NAME_CONTRACT_TYPE_Cash loans',
    # 'ACTIVE_DAYS_CREDIT_ENDDATE_MAX', 'APARTMENTS_MEDI', 'POS_NAME_CONTRACT_STATUS_Active_MEAN', 'INSTAL_PAYMENT_PERC_MEAN',
    # 'ACTIVE_AMT_CREDIT_SUM_LIMIT_SUM', 'PREV_CODE_REJECT_REASON_XAP_MEAN', 'WEEKDAY_APPR_PROCESS_START_SUNDAY', 'OBS_60_CNT_SOCIAL_CIRCLE',
    # 'ACTIVE_AMT_CREDIT_SUM_MEAN', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: high_MEAN', 'CC_AMT_BALANCE_MAX', 'INSTAL_PAYMENT_PERC_SUM',
    # 'BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'DAYS_LAST_PHONE_CHANGE', 'BURO_AMT_CREDIT_SUM_SUM', 'PREV_NAME_CONTRACT_STATUS_Approved_MEAN',
    # 'CC_CNT_DRAWINGS_POS_CURRENT_MAX', 'NEW_RATIO_PREV_CNT_PAYMENT_SUM', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MEAN', 'BURO_DAYS_CREDIT_ENDDATE_MAX',
    # 'BURO_AMT_CREDIT_SUM_MEAN', 'PREV_RATE_DOWN_PAYMENT_MEAN', 'CLOSED_DAYS_CREDIT_MAX', 'PREV_NAME_PORTFOLIO_Cards_MEAN',
    # 'OCCUPATION_TYPE_Low-skill Laborers', 'CC_AMT_INST_MIN_REGULARITY_VAR', 'PREV_NAME_CLIENT_TYPE_Refreshed_MEAN',
    # 'WEEKDAY_APPR_PROCESS_START_WEDNESDAY', 'APPROVED_AMT_APPLICATION_MAX', 'BURO_CREDIT_TYPE_Credit card_MEAN',
    # 'CC_AMT_PAYMENT_TOTAL_CURRENT_SUM', 'INSTAL_DBD_MAX', 'PREV_NAME_CONTRACT_TYPE_Consumer loans_MEAN', 'APPROVED_APP_CREDIT_PERC_MIN',
    # 'APPROVED_DAYS_DECISION_MAX', 'BURO_CREDIT_TYPE_Car loan_MEAN', 'ACTIVE_DAYS_CREDIT_ENDDATE_MEAN',
    # 'WEEKDAY_APPR_PROCESS_START_TUESDAY', 'BURO_DAYS_CREDIT_MAX', 'DAYS_ID_PUBLISH', 'REFUSED_APP_CREDIT_PERC_MIN', 'CC_AMT_RECIVABLE_SUM',
    # 'ACTIVE_DAYS_CREDIT_MEAN', 'PREV_APP_CREDIT_PERC_MEAN',

    # rm17 10 < importance / null_importance <= 12
    'CLOSED_AMT_CREDIT_SUM_MAX', 'APPROVED_RATE_DOWN_PAYMENT_MEAN', 'WEEKDAY_APPR_PROCESS_START_SATURDAY', 'PREV_NAME_PAYMENT_TYPE_Cash through the bank_MEAN', 'PREV_CHANNEL_TYPE_AP+ (Cash loan)_MEAN', 'INSTAL_AMT_PAYMENT_MIN', 'BURO_STATUS_0_MEAN_MEAN', 'CC_AMT_DRAWINGS_POS_CURRENT_SUM', 'FONDKAPREMONT_MODE_reg oper spec account', 'BURO_MONTHS_BALANCE_SIZE_SUM', 'REFUSED_APP_CREDIT_PERC_MEAN', 'REFUSED_DAYS_DECISION_MAX', 'PREV_TIME_DECAYED_HUMAN_EVAL_SUM', 'ACTIVE_DAYS_CREDIT_UPDATE_MEAN', 'PREV_NAME_YIELD_GROUP_middle_MEAN', 'CC_AMT_BALANCE_MIN', 'APPROVED_AMT_GOODS_PRICE_MEAN', 'PREV_AMT_ANNUITY_MIN', 'PREV_NAME_YIELD_GROUP_low_normal_MEAN', 'APPROVED_AMT_DOWN_PAYMENT_MEAN', 'CC_CNT_DRAWINGS_POS_CURRENT_MEAN', 'CC_AMT_DRAWINGS_CURRENT_SUM', 'PREV_NAME_SELLER_INDUSTRY_XNA_MEAN', 'APPROVED_AMT_APPLICATION_MIN', 'APPROVED_AMT_ANNUITY_MIN', 'AMT_REQ_CREDIT_BUREAU_DAY', 'APPROVED_HOUR_APPR_PROCESS_START_MAX', 'PREV_CHANNEL_TYPE_Country-wide_MEAN', 'PREV_RATE_DOWN_PAYMENT_MAX', 'PREV_HOUR_APPR_PROCESS_START_MAX', 'PREV_NAME_PRODUCT_TYPE_XNA_MEAN', 'PREV_NAME_GOODS_CATEGORY_Mobile_MEAN', 'CC_AMT_BALANCE_VAR', 'APPROVED_AMT_ANNUITY_MAX', 'INSTAL_DAYS_ENTRY_PAYMENT_SUM', 'PREV_PRODUCT_COMBINATION_Cash Street: high_MEAN', 'PREV_NAME_SELLER_INDUSTRY_Consumer electronics_MEAN', 'ACTIVE_AMT_CREDIT_SUM_OVERDUE_MEAN', 'APPROVED_AMT_GOODS_PRICE_MIN', 'CLOSED_AMT_CREDIT_SUM_SUM', 'CLOSED_AMT_CREDIT_SUM_MEAN', 'APPROVED_APP_CREDIT_PERC_MEAN', 'CC_CNT_DRAWINGS_POS_CURRENT_VAR', 'APPROVED_DAYS_DECISION_MIN', 'YEARS_BEGINEXPLUATATION_MODE', 'BURO_AMT_CREDIT_SUM_DEBT_MAX', 'COMMONAREA_MEDI', 'NAME_INCOME_TYPE_Commercial associate', 'PREV_AMT_DOWN_PAYMENT_MEAN', 'APPROVED_RATE_DOWN_PAYMENT_MAX', 'NAME_EDUCATION_TYPE_Incomplete higher', 'APPROVED_APP_CREDIT_PERC_MAX', 'DAYS_REGISTRATION', 'INSTAL_PAYMENT_DIFF_MEAN', 'INSTAL_AMT_INSTALMENT_MAX', 'APPROVED_DAYS_DECISION_MEAN', 'PREV_AMT_GOODS_PRICE_MAX', 'INSTAL_DAYS_ENTRY_PAYMENT_MEAN', 'INSTAL_NUM_INSTALMENT_VERSION_NUNIQUE', 'CLOSED_DAYS_CREDIT_ENDDATE_MAX', 'BURO_CREDIT_ACTIVE_Active_MEAN', 'WEEKDAY_APPR_PROCESS_START_FRIDAY', 'NEW_INC_BY_ORG', 'PREV_WEEKDAY_APPR_PROCESS_START_THURSDAY_MEAN', 'CC_SK_DPD_SUM', 'REFUSED_DAYS_DECISION_MEAN', 'PREV_NAME_CONTRACT_TYPE_Cash loans_MEAN', 'FLOORSMIN_MEDI', 'PREV_AMT_DOWN_PAYMENT_MAX', 'CC_AMT_RECEIVABLE_PRINCIPAL_VAR', 'BURO_DAYS_CREDIT_MEAN', 'POS_MONTHS_BALANCE_MEAN', 'PREV_NAME_GOODS_CATEGORY_Furniture_MEAN', 'LANDAREA_MEDI', 'NEW_RATIO_PREV_DAYS_DECISION_MAX', 'CC_AMT_PAYMENT_CURRENT_MEAN', 'HOUSETYPE_MODE_specific housing', 'INSTAL_DBD_MEAN',

    # # rm18 12 < importance / null_importance <= 13
    # 'BURO_AMT_CREDIT_SUM_MAX', 'POS_SK_DPD_DEF_MAX', 'APPROVED_TIME_DECAYED_HUMAN_EVAL_SUM', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_SUM', 'INSTAL_PAYMENT_DIFF_SUM', 'INSTAL_PAYMENT_DIFF_MAX', 'PREV_NAME_GOODS_CATEGORY_XNA_MEAN', 'PREV_APP_CREDIT_PERC_MAX', 'REFUSED_TIME_DECAYED_HUMAN_EVAL_SUM', 'PREV_CODE_REJECT_REASON_SCO_MEAN', 'LIVINGAREA_MEDI', 'NAME_CONTRACT_TYPE_Cash loans', 'ACTIVE_DAYS_CREDIT_ENDDATE_MAX', 'APARTMENTS_MEDI', 'POS_NAME_CONTRACT_STATUS_Active_MEAN', 'INSTAL_PAYMENT_PERC_MEAN', 'ACTIVE_AMT_CREDIT_SUM_LIMIT_SUM', 'PREV_CODE_REJECT_REASON_XAP_MEAN', 'WEEKDAY_APPR_PROCESS_START_SUNDAY', 'OBS_60_CNT_SOCIAL_CIRCLE', 'ACTIVE_AMT_CREDIT_SUM_MEAN', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: high_MEAN', 'CC_AMT_BALANCE_MAX', 'INSTAL_PAYMENT_PERC_SUM', 'BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'DAYS_LAST_PHONE_CHANGE', 'BURO_AMT_CREDIT_SUM_SUM', 'PREV_NAME_CONTRACT_STATUS_Approved_MEAN', 'CC_CNT_DRAWINGS_POS_CURRENT_MAX', 'NEW_RATIO_PREV_CNT_PAYMENT_SUM', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MEAN', 'BURO_DAYS_CREDIT_ENDDATE_MAX', 'BURO_AMT_CREDIT_SUM_MEAN', 'PREV_RATE_DOWN_PAYMENT_MEAN', 'CLOSED_DAYS_CREDIT_MAX', 'PREV_NAME_PORTFOLIO_Cards_MEAN', 'OCCUPATION_TYPE_Low-skill Laborers', 'CC_AMT_INST_MIN_REGULARITY_VAR', 'PREV_NAME_CLIENT_TYPE_Refreshed_MEAN', 'WEEKDAY_APPR_PROCESS_START_WEDNESDAY',
]
...
#     'APPROVED_HUMAN_EVAL_MAX', 'APPROVED_HUMAN_EVAL_MEAN', 'APPROVED_HUMAN_EVAL_MIN', 'NEW_RATIO_PREV_HUMAN_EVAL_MAX','PREV_HUMAN_EVAL_MAX',
#     'NEW_RATIO_PREV_HUMAN_EVAL_MEAN', 'NEW_RATIO_PREV_HUMAN_EVAL_MIN', 'REFUSED_HUMAN_EVAL_MAX', 'REFUSED_HUMAN_EVAL_MEAN', 'REFUSED_HUMAN_EVAL_MIN',
#     'BURO_CREDIT_TYPE_Another type of loan_MEAN', 'NEW_DOC_IND_AVG', 'EXT_SOURCE_3_VAR', 'CC_CNT_DRAWINGS_POS_CURRENT_MIN',

#     # rm3 imp mean <= 5
#     # 'ACTIVE_CREDIT_DAY_OVERDUE_MAX', 'FLAG_DOCUMENT_18', 'NAME_HOUSING_TYPE_Rented apartment', 'PREV_HUMAN_EVAL_MIN', 'PREV_NAME_CASH_LOAN_PURPOSE_Car repairs_MEAN', 'PREV_NAME_TYPE_SUITE_Other_A_MEAN',

#     # rm4 from null hypo imp
#     # 'BURO_DAYS_CREDIT_MAX', 'NEW_EMPLOY_TO_BIRTH_RATIO', 'CLOSED_AMT_CREDIT_SUM_MEAN', 'CLOSED_AMT_ANNUITY_MAX', 'APPROVED_APP_CREDIT_PERC_VAR',
#     #'EXT_SOURCE_3', 'NEW_RATIO_BURO_DAYS_CREDIT_MAX','EXT_SOURCE_1_VAR',

#     # rm5 from null hypo imp & normal imp <= 200
#     # 'CLOSED_AMT_CREDIT_SUM_MEAN', 'CLOSED_AMT_ANNUITY_MAX', 'APPROVED_APP_CREDIT_PERC_VAR','EXT_SOURCE_1_VAR','BURO_DAYS_CREDIT_ENDDATE_MEAN',
#     # 'CLOSED_DAYS_CREDIT_ENDDATE_MEAN','COMMONAREA_MODE','PREV_NAME_CONTRACT_STATUS_Canceled_MEAN','NEW_RATIO_BURO_DAYS_CREDIT_ENDDATE_MIN',

#     # # rm6 from null hypo imp >= 5.0 & normal imp <= 60
#     # 'CLOSED_AMT_ANNUITY_MAX','COMMONAREA_MODE','PREV_NAME_CONTRACT_STATUS_Canceled_MEAN','COMMONAREA_AVG','NEW_RATIO_PREV_HOUR_APPR_PROCESS_START_MAX',
#     # 'REFUSED_AMT_GOODS_PRICE_MIN',

#     # # rm7: feature importance / random feature importance # wrong
#     # 'REG_CITY_NOT_LIVE_CITY', 'APPROVED_AMT_DOWN_PAYMENT_MIN', 'CC_CNT_DRAWINGS_CURRENT_MAX', 'OBS_60_CNT_SOCIAL_CIRCLE', 'ORGANIZATION_TYPE_Self-employed',
#     # 'CLOSED_AMT_ANNUITY_MAX', 'NEW_RATIO_PREV_AMT_GOODS_PRICE_MIN', 'APARTMENTS_AVG', 'NEW_DOC_IND_KURT', 'FLAG_WORK_PHONE', 'ACTIVE_AMT_CREDIT_SUM_LIMIT_SUM',

#     # # rm8 feature importance / random feature importance
#     # 'PREV_NAME_TYPE_SUITE_Other_A_MEAN', 'CLOSED_AMT_CREDIT_SUM_DEBT_SUM', 'REFUSED_AMT_DOWN_PAYMENT_MIN', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_DEBT_MAX',
#     # 'ACTIVE_CREDIT_DAY_OVERDUE_MAX', 'CC_NAME_CONTRACT_STATUS_Active_VAR', 'YEARS_BUILD_AVG', 'NEW_RATIO_BURO_MONTHS_BALANCE_SIZE_MEAN',
#     # 'CC_CNT_INSTALMENT_MATURE_CUM_VAR', 'PREV_NAME_TYPE_SUITE_Children_MEAN', 'NEW_RATIO_BURO_AMT_ANNUITY_MAX', 'NEW_RATIO_PREV_RATE_DOWN_PAYMENT_MIN',
# ]
...
def application_train_test(nan_as_category = False):
    ...
    df['NEW_CREDIT_TO_GOODS_RATIO'] = df['AMT_CREDIT'] / df['AMT_GOODS_PRICE'] # rm1+fe13 good
    # df['DIFF_CREDIT_AND_GOODS_RATIO'] = df['AMT_CREDIT'] - df['AMT_GOODS_PRICE'] # rm1+fe13 good
    # df.drop(['AMT_GOODS_PRICE'], axis=1, inplace= True) # rm2
    ...
    # df['ANNUITY_TO_GOODS_PRICE_RATIO'] = df['AMT_ANNUITY'] / df['AMT_GOODS_PRICE'] # fe9
    # df['DIFF_ANNUITY_AND_GOODS_PRICE'] = df['AMT_ANNUITY'] - df['AMT_GOODS_PRICE'] # fe11
    # df['INCOME_TO_GOODS_PRICE_RATIO'] = df['AMT_INCOME_TOTAL'] / df['AMT_GOODS_PRICE'] # fe10 good
    # df['DIFF_INCOME_AND_GOODS_PRICE'] = df['AMT_INCOME_TOTAL'] - df['AMT_GOODS_PRICE'] # fe12 good
    ...
    # # fe4
    # df['EXT_SOURCE_1_VAR'] = fillna_with_gaussian(df['EXT_SOURCE_1_VAR'])
    # df['EXT_SOURCE_2_VAR'] = fillna_with_gaussian(df['EXT_SOURCE_2_VAR'])
    # df['EXT_SOURCE_3_VAR'] = fillna_with_gaussian(df['EXT_SOURCE_3_VAR'])
    ...
    # fe2
    # df['EXT_SOURCE_1'] = -np.log(1/df['EXT_SOURCE_1'] - 1)
    # df['EXT_SOURCE_2'] = -np.log(1/df['EXT_SOURCE_2'] - 1)
    # df['EXT_SOURCE_3'] = -np.log(1/df['EXT_SOURCE_3'] - 1)

    # df['NEW_EXT_SOURCES_MEAN'] = df[['EXT_SOURCE_1', 'EXT_SOURCE_2', 'EXT_SOURCE_3']].mean(axis=1) # fe3

    # to do: personal value / mode_or_median
    # df['SOCIAL_PRED'] = df['OBS_30_CNT_SOCIAL_CIRCLE'] + df['DEF_30_CNT_SOCIAL_CIRCLE'] + 2*df['OBS_60_CNT_SOCIAL_CIRCLE'] + 2*df['DEF_60_CNT_SOCIAL_CIRCLE'] # fe6 good
    # df['SOCIAL_PRED'] = df['OBS_30_CNT_SOCIAL_CIRCLE'] + df['DEF_30_CNT_SOCIAL_CIRCLE'] + df['OBS_60_CNT_SOCIAL_CIRCLE'] + df['DEF_60_CNT_SOCIAL_CIRCLE'] # fe7
    # df['SOCIAL_PRED'] = df['OBS_30_CNT_SOCIAL_CIRCLE'] + df['DEF_30_CNT_SOCIAL_CIRCLE'] # fe8
...
def previous_applications(nan_as_category = True):
    ...
    # prev['CNT_PREV_APPS'] = prev['NAME_CONTRACT_STATUS_Approved'] + prev['NAME_CONTRACT_STATUS_Refused'] # fe1
    ...
    num_aggregations = {
        ...
        'HUMAN_EVAL': ['min', 'max', 'mean'], # ,'sum'], # fe5 good
...
def kfold_lightgbm(df, num_folds, stratified = False):
    ...
    if TEST_NULL_HYPO:
        ...
        # train_df.loc[:,'TARGET'] = train_df.groupby('SK_ID_CURR')['TARGET'].transform(np.random.permutation).values
