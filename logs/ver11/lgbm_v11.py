...
USE_SELECTED_VAL = True
VAL_DATA_RATE = 0.05 # to select validation data by istest_pred
...
FEATURE_GRAVEYARD = [
    ...
    # rm1 for non-residual
    # 'ORGANIZATION_TYPE_Restaurant', 'OCCUPATION_TYPE_High skill tech staff', 'PREV_CODE_REJECT_REASON_CLIENT_MEAN', 'ORGANIZATION_TYPE_Medicine', 'OCCUPATION_TYPE_Laborers', 'NAME_EDUCATION_TYPE_Lower secondary', 'ORGANIZATION_TYPE_Kindergarten', 'CC_AMT_TOTAL_RECEIVABLE_MIN', 'EXT_SOURCE_3_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'EXT_SOURCE_2_VAR', 'LIVINGAREA_MEDI', 'ENTRANCES_MEDI', 'YEARS_BEGINEXPLUATATION_MEDI', 'OCCUPATION_TYPE_Sales staff', 'ORGANIZATION_TYPE_Police', 'DAYS_REGISTRATION_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'FLAG_DOCUMENT_18', 'CC_AMT_RECIVABLE_SUM', 'EXT_SOURCE_2_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'APARTMENTS_MEDI', 'INSTAL_AMT_PAYMENT_MIN_MIN', 'EXT_SOURCE_3_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'PREV_NAME_GOODS_CATEGORY_Sport and Leisure_MEAN', 'WEEKDAY_APPR_PROCESS_START_SUNDAY', 'ORGANIZATION_TYPE_Business Entity Type 3', 'PREV_HUMAN_EVAL_SUM', 'DAYS_EMPLOYED_BY_NAME_INCOME_TYPE_OCCUPATION_TYPE', 'CNT_FAM_MEMBERS_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'WEEKDAY_APPR_PROCESS_START_TUESDAY', 'PREV_CODE_REJECT_REASON_SCO_MEAN', 'OBS_60_CNT_SOCIAL_CIRCLE', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_SUM', 'POS_NAME_CONTRACT_STATUS_Active_MEAN', 'DAYS_ID_PUBLISH_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'WALLSMATERIAL_MODE_Others', 'REFUSED_AMT_CREDIT_MIN', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MEAN', 'DAYS_BIRTH_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'SOCIAL_PRED', 'PREV_RATE_DOWN_PAYMENT_MEAN', 'AMT_ANNUITY_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'REFUSED_APP_CREDIT_PERC_MIN', 'CLOSED_DAYS_CREDIT_MAX', 'CC_CNT_DRAWINGS_POS_CURRENT_MAX', 'APPROVED_HUMAN_EVAL_SUM', 'PREV_NAME_PAYMENT_TYPE_XNA_MEAN', 'PREV_NAME_CLIENT_TYPE_Refreshed_MEAN', 'INCOME_TO_GOODS_PRICE_RATIO', 'OWN_CAR_AGE', 'DAYS_ID_PUBLISH', 'CNT_CHILDREN_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: high_MEAN', 'PREV_NAME_TYPE_SUITE_nan_MEAN', 'BURO_CREDIT_TYPE_Car loan_MEAN', 'DAYS_LAST_PHONE_CHANGE', 'PREV_NAME_YIELD_GROUP_XNA_MEAN', 'PREV_NAME_PORTFOLIO_Cards_MEAN', 'BURO_CREDIT_TYPE_Credit card_MEAN', 'POS_MONTHS_BALANCE_SIZE', 'REFUSED_TIME_DECAYED_HUMAN_EVAL_SUM', 'PREV_NAME_TYPE_SUITE_Unaccompanied_MEAN', 'PREV_APP_CREDIT_PERC_MAX', 'ACTIVE_DAYS_CREDIT_MEAN', 'CC_AMT_INST_MIN_REGULARITY_VAR', 'ORGANIZATION_TYPE_School', 'PREV_NAME_YIELD_GROUP_low_action_MEAN', 'DAYS_BIRTH_BY_NAME_INCOME_TYPE_OCCUPATION_TYPE', 'APPROVED_AMT_DOWN_PAYMENT_MAX', 'POS_SK_DPD_DEF_MAX', 'EXT_SOURCE_1_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'INSTAL_PAYMENT_PERC_MEAN_MEAN', 'DAYS_REGISTRATION_BY_CODE_GENDER_OCCUPATION_TYPE', 'INSTAL_PAYMENT_DIFF_SUM_SUM', 'APPROVED_DAYS_DECISION_MAX', 'REGION_POPULATION_RELATIVE', 'PREV_APP_CREDIT_PERC_MEAN', 'NEW_ANNUITY_TO_INCOME_RATIO', 'DAYS_EMPLOYED_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'ACTIVE_DAYS_CREDIT_ENDDATE_MIN', 'NEW_RATIO_PREV_TIME_DECAYED_HUMAN_EVAL_SUM', 'WEEKDAY_APPR_PROCESS_START_WEDNESDAY', 'CC_AMT_RECIVABLE_VAR', 'INSTAL_PAYMENT_PERC_SUM_SUM', 'BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'BURO_AMT_CREDIT_SUM_MEAN', 'INSTAL_PAYMENT_DIFF_MAX_MAX', 'CNT_CHILDREN_BY_CODE_GENDER_OCCUPATION_TYPE', 'NEW_RATIO_PREV_CNT_PAYMENT_SUM', 'NEW_EMPLOY_TO_BIRTH_RATIO', 'PREV_NAME_SELLER_INDUSTRY_Connectivity_MEAN', 'BURO_AMT_CREDIT_SUM_OVERDUE_MEAN', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'ORGANIZATION_TYPE_Security Ministries', 'EXT_SOURCE_3', 'PREV_HUMAN_EVAL_MEAN', 'EXT_SOURCE_3_BY_CODE_GENDER_OCCUPATION_TYPE', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: low_MEAN', 'DAYS_REGISTRATION_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'ORGANIZATION_TYPE_Hotel', 'DAYS_EMPLOYED', 'CNT_CHILDREN_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'ACTIVE_AMT_CREDIT_SUM_LIMIT_SUM', 'EXT_SOURCE_3_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'INSTAL_AMT_PAYMENT_MAX_MAX', 'NEW_SOURCES_PROD', 'BURO_AMT_CREDIT_MAX_OVERDUE_MEAN', 'DAYS_BIRTH_BY_CODE_GENDER_OCCUPATION_TYPE', 'NAME_HOUSING_TYPE_Municipal apartment', 'DIFF_INCOME_AND_GOODS_PRICE', 'ACTIVE_DAYS_CREDIT_ENDDATE_MEAN', 'ORGANIZATION_TYPE_Construction', 'NEW_RATIO_PREV_HUMAN_EVAL_SUM', 'PREV_CHANNEL_TYPE_Credit and cash offices_MEAN', 'INSTAL_DAYS_ENTRY_PAYMENT_MAX_MAX', 'PREV_NAME_CONTRACT_STATUS_Approved_MEAN', 'APPROVED_TIME_DECAYED_HUMAN_EVAL_SUM', 'AMT_ANNUITY', 'BURO_DAYS_CREDIT_ENDDATE_MAX', 'PREV_AMT_ANNUITY_MEAN', 'EXT_SOURCE_2', 'DAYS_BIRTH_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'PREV_PRODUCT_COMBINATION_Cash Street: low_MEAN', 'CNT_FAM_MEMBERS_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'POS_SK_DPD_DEF_MEAN', 'PREV_NAME_PRODUCT_TYPE_walk-in_MEAN', 'DAYS_EMPLOYED_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'ACTIVE_DAYS_CREDIT_ENDDATE_MAX', 'NAME_FAMILY_STATUS_Single / not married', 'APARTMENTS_AVG_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'BURO_DAYS_CREDIT_MAX', 'PREV_CHANNEL_TYPE_Channel of corporate sales_MEAN', 'CC_AMT_DRAWINGS_ATM_CURRENT_MEAN', 'BURO_AMT_CREDIT_SUM_SUM', 'APPROVED_CNT_PAYMENT_SUM', 'PREV_NAME_CLIENT_TYPE_New_MEAN', 'AMT_CREDIT_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'AMT_ANNUITY_BY_NAME_INCOME_TYPE_OCCUPATION_TYPE', 'APPROVED_APP_CREDIT_PERC_MIN',
    # rm2 for residual
    # 'PREV_CODE_REJECT_REASON_CLIENT_MEAN', 'YEARS_BUILD_AVG_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'BASEMENTAREA_AVG_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'ORGANIZATION_TYPE_Restaurant', 'CC_AMT_TOTAL_RECEIVABLE_MIN', 'NONLIVINGAREA_AVG_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'EXT_SOURCE_2_VAR', 'OCCUPATION_TYPE_Sales staff', 'AMT_INCOME_TOTAL_BY_CODE_GENDER_NAME_EDUCATION_TYPE', 'AMT_REQ_CREDIT_BUREAU_YEAR_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'LIVINGAREA_MEDI', 'ENTRANCES_MEDI', 'APARTMENTS_AVG_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'YEARS_BEGINEXPLUATATION_MEDI', 'CC_AMT_RECIVABLE_SUM', 'OWN_CAR_AGE_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'AMT_INCOME_TOTAL_BY_NAME_INCOME_TYPE_OCCUPATION_TYPE', 'PREV_HUMAN_EVAL_SUM', 'FLAG_DOCUMENT_18', 'OBS_60_CNT_SOCIAL_CIRCLE', 'WEEKDAY_APPR_PROCESS_START_TUESDAY', 'INSTAL_AMT_PAYMENT_MIN_MIN', 'ORGANIZATION_TYPE_Hotel', 'POS_NAME_CONTRACT_STATUS_Active_MEAN', 'APPROVED_HUMAN_EVAL_SUM', 'CNT_FAM_MEMBERS_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'PREV_NAME_CLIENT_TYPE_Refreshed_MEAN', 'CLOSED_DAYS_CREDIT_MAX', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_SUM', 'PREV_RATE_DOWN_PAYMENT_MEAN', 'SOCIAL_PRED', 'APARTMENTS_MEDI', 'CC_CNT_DRAWINGS_POS_CURRENT_MAX', 'PREV_CODE_REJECT_REASON_SCO_MEAN', 'INCOME_TO_GOODS_PRICE_RATIO', 'WEEKDAY_APPR_PROCESS_START_SUNDAY', 'DAYS_LAST_PHONE_CHANGE', 'BURO_CREDIT_TYPE_Car loan_MEAN', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MEAN', 'REFUSED_AMT_CREDIT_MIN', 'PREV_NAME_GOODS_CATEGORY_Sport and Leisure_MEAN', 'PREV_NAME_TYPE_SUITE_nan_MEAN', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: high_MEAN', 'PREV_NAME_PAYMENT_TYPE_XNA_MEAN', 'CC_AMT_INST_MIN_REGULARITY_VAR', 'LIVE_CITY_NOT_WORK_CITY', 'PREV_NAME_TYPE_SUITE_Unaccompanied_MEAN', 'BURO_CREDIT_TYPE_Credit card_MEAN', 'POS_MONTHS_BALANCE_SIZE', 'CNT_CHILDREN_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'CNT_CHILDREN_BY_CODE_GENDER_OCCUPATION_TYPE', 'PREV_APP_CREDIT_PERC_MAX', 'ORGANIZATION_TYPE_Kindergarten', 'REFUSED_APP_CREDIT_PERC_MIN', 'DAYS_BIRTH_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'ACTIVE_DAYS_CREDIT_MEAN', 'PREV_NAME_YIELD_GROUP_XNA_MEAN', 'INSTAL_PAYMENT_PERC_MEAN_MEAN', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: low_MEAN', 'APPROVED_DAYS_DECISION_MAX', 'REGION_POPULATION_RELATIVE', 'INSTAL_PAYMENT_DIFF_SUM_SUM', 'APPROVED_AMT_DOWN_PAYMENT_MAX', 'PREV_APP_CREDIT_PERC_MEAN', 'POS_SK_DPD_DEF_MAX', 'BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'INSTAL_PAYMENT_DIFF_MAX_MAX', 'WEEKDAY_APPR_PROCESS_START_WEDNESDAY', 'NAME_HOUSING_TYPE_House / apartment', 'INSTAL_PAYMENT_PERC_SUM_SUM', 'REFUSED_TIME_DECAYED_HUMAN_EVAL_SUM', 'CNT_FAM_MEMBERS_BY_CODE_GENDER_OCCUPATION_TYPE', 'NEW_ANNUITY_TO_INCOME_RATIO', 'PREV_NAME_YIELD_GROUP_low_action_MEAN', 'CC_AMT_RECIVABLE_VAR', 'ACTIVE_DAYS_CREDIT_ENDDATE_MIN', 'PREV_NAME_SELLER_INDUSTRY_Connectivity_MEAN', 'CNT_CHILDREN_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'DAYS_REGISTRATION_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'BURO_AMT_CREDIT_SUM_MEAN', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'NAME_TYPE_SUITE_Other_B', 'DAYS_ID_PUBLISH', 'INSTAL_DAYS_ENTRY_PAYMENT_MAX_MAX', 'NEW_RATIO_PREV_CNT_PAYMENT_SUM', 'BURO_DAYS_CREDIT_MAX', 'PREV_NAME_PORTFOLIO_Cards_MEAN', 'DIFF_INCOME_AND_GOODS_PRICE', 'BURO_DAYS_CREDIT_ENDDATE_MAX', 'INSTAL_AMT_PAYMENT_MAX_MAX', 'DAYS_EMPLOYED_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'ORGANIZATION_TYPE_Medicine', 'APPROVED_TIME_DECAYED_HUMAN_EVAL_SUM', 'NEW_RATIO_PREV_TIME_DECAYED_HUMAN_EVAL_SUM', 'BURO_AMT_CREDIT_SUM_OVERDUE_MEAN', 'ACTIVE_DAYS_CREDIT_ENDDATE_MEAN', 'PREV_AMT_ANNUITY_MEAN', 'BURO_AMT_CREDIT_MAX_OVERDUE_MEAN', 'PREV_HUMAN_EVAL_MEAN', 'PREV_NAME_CONTRACT_STATUS_Approved_MEAN', 'NEW_SOURCES_PROD', 'EXT_SOURCE_1_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'APPROVED_CNT_PAYMENT_SUM', 'DAYS_EMPLOYED_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'OWN_CAR_AGE', 'EXT_SOURCE_1_BY_CODE_GENDER_OCCUPATION_TYPE', 'ACTIVE_DAYS_CREDIT_ENDDATE_MAX', 'CNT_FAM_MEMBERS_BY_OCCUPATION_TYPE', 'PREV_CHANNEL_TYPE_Credit and cash offices_MEAN', 'BURO_AMT_CREDIT_SUM_SUM', 'DAYS_REGISTRATION_BY_OCCUPATION_TYPE', 'DAYS_EMPLOYED_BY_NAME_INCOME_TYPE_OCCUPATION_TYPE', 'APPROVED_AMT_CREDIT_MAX', 'INSTAL_DBD_MAX_MAX', 'DAYS_ID_PUBLISH_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'NAME_FAMILY_STATUS_Single / not married', 'AMT_ANNUITY_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'ACTIVE_AMT_CREDIT_SUM_LIMIT_SUM', 'AMT_GOODS_PRICE_BY_NAME_INCOME_TYPE_OCCUPATION_TYPE', 'APPROVED_APP_CREDIT_PERC_MIN', 'FLAG_PHONE', 'PREV_NAME_PRODUCT_TYPE_walk-in_MEAN', 'EXT_SOURCE_2_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'CC_CNT_DRAWINGS_ATM_CURRENT_VAR', 'POS_SK_DPD_DEF_MEAN', 'CNT_FAM_MEMBERS_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'NEW_RATIO_PREV_HUMAN_EVAL_SUM', 'DAYS_EMPLOYED_BY_CODE_GENDER_OCCUPATION_TYPE', 'DAYS_REGISTRATION_BY_CODE_GENDER_OCCUPATION_TYPE', 'CC_AMT_DRAWINGS_ATM_CURRENT_MEAN', 'ACTIVE_AMT_CREDIT_SUM_MEAN', 'AMT_ANNUITY', 'PREV_NAME_CLIENT_TYPE_New_MEAN', 'NEW_EMPLOY_TO_BIRTH_RATIO', 'PREV_PRODUCT_COMBINATION_Cash Street: low_MEAN', 'BURO_AMT_CREDIT_SUM_MAX', 'NAME_HOUSING_TYPE_Municipal apartment', 'APPROVED_AMT_ANNUITY_MEAN', 'WALLSMATERIAL_MODE_Others', 'ACTIVE_AMT_CREDIT_MAX_OVERDUE_MEAN', 'CNT_CHILDREN_BY_OCCUPATION_TYPE', 'EXT_SOURCE_1_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE', 'DAYS_ID_PUBLISH_BY_CODE_GENDER_OCCUPATION_TYPE', 'POS_TIME_DECAYED_UNPAYED_RATIO_MEAN', 'EXT_SOURCE_2_BY_ORGANIZATION_TYPE_OCCUPATION_TYPE', 'PREV_APP_CREDIT_PERC_MIN', 'AMT_REQ_CREDIT_BUREAU_QRT', 'CC_AMT_PAYMENT_TOTAL_CURRENT_MEAN', 'DAYS_REGISTRATION_BY_REG_CITY_NOT_WORK_CITY_OCCUPATION_TYPE', 'WEEKDAY_APPR_PROCESS_START_MONDAY', 'BURO_AMT_CREDIT_SUM_DEBT_MEAN',
    # rm3
    # 'PREV_CODE_REJECT_REASON_CLIENT_MEAN', 'YEARS_BUILD_AVG_BY_NAME_EDUCATION_TYPE_OCCUPATION_TYPE',
]
...
AGG_RECIPE = [
    ...
    # # rm4 good
    # (['CODE_GENDER', 'FLAG_OWN_CAR'], [ # fe1 slightly better
    #     ('DAYS_BIRTH', 'mean'),
    #     ('DAYS_EMPLOYED', 'mean'),
    # ]),
    # # rm4 good
    # (['CODE_GENDER', 'FLAG_EMP_PHONE'], [ # fe1 slightly better
    #     ('DAYS_BIRTH', 'mean'),
    #     ('DAYS_EMPLOYED', 'mean'),
    # ]),
...
def selected_val_lightgbm(df, stratified = False):
    # Divide in training/validation and test data
    train_df = df[df['TARGET'].notnull()]
    test_df = df[df['TARGET'].isnull()]
    print("Starting LightGBM. Train shape: {}, test shape: {}".format(train_df.shape, test_df.shape))
    ...
    if TEST_NULL_HYPO:
        ...
        clf = LGBMClassifier(
            ...
            learning_rate=0.02,
            num_leaves=34, # 20
            colsample_bytree=0.2, # 0.9497036
            subsample=0.8715623,
            max_depth=8, # 7
            reg_alpha=0.041545473, # 0.3
            reg_lambda=0.0735294,
...
def main():
    ...
    with timer("Run LightGBM with kfold"):
        ...
        for i in range(ITERATION):
            print('Iteration %i' %i)
            if USE_SELECTED_VAL:
                iter_feat_imp, over_folds_val_auc = selected_val_lightgbm(df)
            else:
