...
# # ver12.1.3
# REVIVE_FEATURES = ['CLOSED_DAYS_CREDIT_MAX', 'ACTIVE_DAYS_CREDIT_ENDDATE_MIN', 'BURO_DAYS_CREDIT_ENDDATE_MAX', 'BURO_DAYS_CREDIT_MAX', 'INSTAL_AMT_PAYMENT_MAX_MAX', 'NEW_ANNUITY_TO_INCOME_RATIO', 'ACTIVE_DAYS_CREDIT_MEAN', 'BURO_AMT_CREDIT_SUM_SUM', 'APPROVED_AMT_DOWN_PAYMENT_MAX', 'PREV_AMT_ANNUITY_MEAN', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_SUM', 'BURO_AMT_CREDIT_SUM_MEAN', 'INSTAL_DBD_MAX_MAX', 'REGION_POPULATION_RELATIVE', 'INSTAL_AMT_PAYMENT_MIN_MIN', 'ACTIVE_DAYS_CREDIT_ENDDATE_MAX', 'DAYS_ID_PUBLISH', 'PREV_APP_CREDIT_PERC_MEAN', 'NEW_SOURCES_PROD', 'ACTIVE_DAYS_CREDIT_ENDDATE_MEAN', 'DAYS_LAST_PHONE_CHANGE', 'INSTAL_DAYS_ENTRY_PAYMENT_MAX_MAX', 'BURO_AMT_CREDIT_MAX_OVERDUE_MEAN', 'PREV_APP_CREDIT_PERC_MAX', 'POS_MONTHS_BALANCE_SIZE', 'POS_NAME_CONTRACT_STATUS_Active_MEAN', 'INCOME_TO_GOODS_PRICE_RATIO', 'INSTAL_PAYMENT_PERC_SUM_SUM', 'APPROVED_DAYS_DECISION_MAX', 'APPROVED_AMT_CREDIT_MAX', 'INSTAL_PAYMENT_PERC_MEAN_MEAN', 'PREV_RATE_DOWN_PAYMENT_MEAN', 'APPROVED_TIME_DECAYED_HUMAN_EVAL_SUM', 'APPROVED_CNT_PAYMENT_SUM', 'DIFF_INCOME_AND_GOODS_PRICE', 'NEW_RATIO_PREV_TIME_DECAYED_HUMAN_EVAL_SUM', 'INSTAL_PAYMENT_DIFF_SUM_SUM', 'APPROVED_APP_CREDIT_PERC_MIN', 'YEARS_BEGINEXPLUATATION_MEDI', 'REFUSED_TIME_DECAYED_HUMAN_EVAL_SUM', 'APARTMENTS_MEDI', 'LIVINGAREA_MEDI', 'OWN_CAR_AGE', 'INSTAL_PAYMENT_DIFF_MAX_MAX', 'PREV_HUMAN_EVAL_MEAN', 'NEW_RATIO_PREV_CNT_PAYMENT_SUM', 'BURO_CREDIT_TYPE_Credit card_MEAN', 'PREV_NAME_TYPE_SUITE_Unaccompanied_MEAN', 'PREV_NAME_TYPE_SUITE_nan_MEAN', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MEAN', 'PREV_NAME_PAYMENT_TYPE_XNA_MEAN', 'PREV_CHANNEL_TYPE_Credit and cash offices_MEAN', 'EXT_SOURCE_2_VAR', 'PREV_NAME_CONTRACT_STATUS_Approved_MEAN', 'BURO_AMT_CREDIT_SUM_LIMIT_MEAN', 'PREV_NAME_SELLER_INDUSTRY_Connectivity_MEAN', 'PREV_NAME_YIELD_GROUP_XNA_MEAN', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: low_MEAN', 'SOCIAL_PRED', 'PREV_HUMAN_EVAL_SUM',]
# # ver12.1.4
# REVIVE_FEATURES = ['DAYS_REGISTRATION', 'CLOSED_DAYS_CREDIT_ENDDATE_MAX', 'ACTIVE_DAYS_CREDIT_UPDATE_MEAN', 'CLOSED_DAYS_CREDIT_VAR', 'NEW_RATIO_BURO_DAYS_CREDIT_MAX', 'PREV_APP_CREDIT_PERC_VAR', 'CLOSED_AMT_CREDIT_SUM_MEAN', 'NEW_RATIO_BURO_DAYS_CREDIT_ENDDATE_MAX', 'BURO_DAYS_CREDIT_MEAN', 'BURO_DAYS_CREDIT_ENDDATE_MEAN', 'POS_MONTHS_BALANCE_MEAN', 'PREV_DAYS_DECISION_MAX', 'CLOSED_AMT_CREDIT_SUM_SUM', 'BURO_DAYS_CREDIT_VAR', 'APPROVED_APP_CREDIT_PERC_VAR', 'INCOME_PER_PERSON', 'PREV_HOUR_APPR_PROCESS_START_MEAN', 'CLOSED_DAYS_CREDIT_UPDATE_MEAN', 'POS_NAME_CONTRACT_STATUS_Completed_MEAN', 'ACTIVE_DAYS_CREDIT_VAR', 'EXT_SOURCE_1_VAR', 'NEW_RATIO_BURO_DAYS_CREDIT_UPDATE_MEAN', 'NEW_RATIO_BURO_DAYS_CREDIT_ENDDATE_MIN', 'CLOSED_AMT_CREDIT_SUM_MAX', 'PREV_AMT_ANNUITY_MIN', 'NEW_RATIO_BURO_DAYS_CREDIT_MEAN', 'NEW_RATIO_BURO_DAYS_CREDIT_ENDDATE_MEAN', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_MAX', 'APPROVED_APP_CREDIT_PERC_MEAN', 'BURO_DAYS_CREDIT_UPDATE_MEAN', 'PREV_DAYS_DECISION_MEAN', 'APPROVED_HOUR_APPR_PROCESS_START_MEAN', 'AMT_INCOME_TOTAL', 'PREV_TIME_DECAYED_HUMAN_EVAL_SUM', 'NEW_RATIO_BURO_AMT_CREDIT_SUM_MEAN', 'APPROVED_DAYS_DECISION_MEAN', 'CLOSED_AMT_CREDIT_MAX_OVERDUE_MEAN', 'BURO_STATUS_0_MEAN_MEAN', 'PREV_AMT_DOWN_PAYMENT_MAX', 'APPROVED_AMT_ANNUITY_MIN', 'NEW_RATIO_BURO_DAYS_CREDIT_MIN', 'BURO_DAYS_CREDIT_MIN', 'CLOSED_DAYS_CREDIT_ENDDATE_MEAN', 'ACTIVE_DAYS_CREDIT_MIN', 'APPROVED_AMT_CREDIT_MIN', 'NEW_INC_PER_CHLD', 'APPROVED_APP_CREDIT_PERC_MAX', 'APPROVED_AMT_ANNUITY_MAX', 'HOUR_APPR_PROCESS_START', 'PREV_WEEKDAY_APPR_PROCESS_START_THURSDAY_MEAN', 'NEW_RATIO_PREV_DAYS_DECISION_MAX', 'NEW_RATIO_BURO_DAYS_CREDIT_VAR', 'PREV_AMT_ANNUITY_MAX', 'TOTALAREA_MODE', 'CLOSED_DAYS_CREDIT_MEAN', 'PREV_NAME_YIELD_GROUP_middle_MEAN', 'PREV_AMT_CREDIT_MEAN', 'PREV_AMT_DOWN_PAYMENT_MEAN', 'APPROVED_AMT_GOODS_PRICE_MIN', 'PREV_DAYS_DECISION_MIN', 'APPROVED_DAYS_DECISION_MIN', 'PREV_AMT_GOODS_PRICE_MIN', 'BURO_DAYS_CREDIT_ENDDATE_MIN', 'BURO_AMT_CREDIT_SUM_DEBT_MAX', 'PREV_WEEKDAY_APPR_PROCESS_START_MONDAY_MEAN', 'CLOSED_DAYS_CREDIT_MIN', 'PREV_AMT_APPLICATION_MEAN', 'CLOSED_DAYS_CREDIT_ENDDATE_MIN', 'PREV_NAME_YIELD_GROUP_low_normal_MEAN', 'PREV_WEEKDAY_APPR_PROCESS_START_FRIDAY_MEAN', 'NEW_RATIO_PREV_DAYS_DECISION_MIN', 'PREV_RATE_DOWN_PAYMENT_MAX', 'APPROVED_AMT_APPLICATION_MIN', 'BURO_CREDIT_TYPE_Consumer credit_MEAN', 'APPROVED_AMT_DOWN_PAYMENT_MEAN', 'PREV_CNT_PAYMENT_SUM', 'NEW_RATIO_PREV_HOUR_APPR_PROCESS_START_MEAN', 'CC_AMT_PAYMENT_CURRENT_MEAN', 'PREV_AMT_GOODS_PRICE_MEAN', 'ACTIVE_MONTHS_BALANCE_SIZE_MEAN', 'PREV_WEEKDAY_APPR_PROCESS_START_SATURDAY_MEAN', 'NEW_RATIO_PREV_AMT_ANNUITY_MAX', 'APPROVED_RATE_DOWN_PAYMENT_MAX', 'PREV_AMT_CREDIT_MAX', 'PREV_CHANNEL_TYPE_Country-wide_MEAN', 'BURO_STATUS_X_MEAN_MEAN', 'YEARS_BEGINEXPLUATATION_MODE', 'PREV_WEEKDAY_APPR_PROCESS_START_WEDNESDAY_MEAN', 'APPROVED_RATE_DOWN_PAYMENT_MEAN', 'PREV_NAME_SELLER_INDUSTRY_Consumer electronics_MEAN', 'PREV_HOUR_APPR_PROCESS_START_MAX', 'REFUSED_AMT_ANNUITY_MIN', 'BURO_STATUS_1_MEAN_MEAN', 'NEW_RATIO_PREV_APP_CREDIT_PERC_MAX', 'APPROVED_HOUR_APPR_PROCESS_START_MAX', 'PREV_WEEKDAY_APPR_PROCESS_START_TUESDAY_MEAN', 'CLOSED_MONTHS_BALANCE_SIZE_MEAN', 'APPROVED_AMT_CREDIT_MEAN', 'POS_SK_DPD_MEAN', 'NEW_RATIO_PREV_APP_CREDIT_PERC_MEAN', 'BURO_MONTHS_BALANCE_SIZE_SUM', 'REFUSED_DAYS_DECISION_MAX', 'APPROVED_AMT_APPLICATION_MEAN', 'BURO_MONTHS_BALANCE_SIZE_MEAN', 'NEW_RATIO_PREV_AMT_ANNUITY_MIN', 'REFUSED_HOUR_APPR_PROCESS_START_MEAN', 'PREV_PRODUCT_COMBINATION_POS household with interest_MEAN', 'BURO_STATUS_C_MEAN_MEAN', 'NEW_RATIO_PREV_CNT_PAYMENT_MEAN', 'NEW_RATIO_PREV_DAYS_DECISION_MEAN', 'BURO_CREDIT_ACTIVE_Active_MEAN', 'APARTMENTS_MODE', 'NEW_RATIO_PREV_HOUR_APPR_PROCESS_START_MIN', 'NEW_RATIO_PREV_AMT_ANNUITY_MEAN', 'REFUSED_DAYS_DECISION_MIN', 'LANDAREA_MODE', 'APPROVED_AMT_GOODS_PRICE_MEAN', 'PREV_AMT_CREDIT_MIN', 'PREV_CHANNEL_TYPE_Stone_MEAN', 'REFUSED_DAYS_DECISION_MEAN', 'PREV_NAME_TYPE_SUITE_Family_MEAN', 'LANDAREA_AVG', 'NEW_RATIO_PREV_HOUR_APPR_PROCESS_START_MAX', 'PREV_NAME_PRODUCT_TYPE_XNA_MEAN', 'LIVINGAREA_MODE', 'PREV_NAME_PAYMENT_TYPE_Cash through the bank_MEAN', 'PREV_RATE_DOWN_PAYMENT_MIN', 'PREV_AMT_APPLICATION_MIN', 'NEW_RATIO_PREV_AMT_GOODS_PRICE_MEAN', 'CC_AMT_CREDIT_LIMIT_ACTUAL_SUM', 'APARTMENTS_AVG', 'BURO_AMT_ANNUITY_MEAN', 'YEARS_BEGINEXPLUATATION_AVG', 'PREV_NAME_PRODUCT_TYPE_x-sell_MEAN', 'REFUSED_APP_CREDIT_PERC_MEAN', 'ACTIVE_MONTHS_BALANCE_SIZE_SUM', 'PREV_NAME_GOODS_CATEGORY_Mobile_MEAN', 'LIVINGAREA_AVG', 'REFUSED_APP_CREDIT_PERC_VAR', 'PREV_PRODUCT_COMBINATION_Cash Street: high_MEAN', 'CC_AMT_PAYMENT_CURRENT_VAR', 'AMT_REQ_CREDIT_BUREAU_YEAR', 'PREV_NAME_CLIENT_TYPE_Repeater_MEAN', 'PREV_AMT_APPLICATION_MAX', 'CLOSED_AMT_ANNUITY_MAX', 'BASEMENTAREA_AVG', 'PREV_NAME_PORTFOLIO_Cash_MEAN', 'NEW_RATIO_PREV_AMT_CREDIT_MIN', 'PREV_NAME_CASH_LOAN_PURPOSE_XNA_MEAN', 'APPROVED_HOUR_APPR_PROCESS_START_MIN', 'BURO_AMT_ANNUITY_MAX', 'CLOSED_MONTHS_BALANCE_SIZE_SUM', 'BASEMENTAREA_MODE', 'PREV_NAME_CONTRACT_STATUS_Canceled_MEAN', 'APPROVED_RATE_DOWN_PAYMENT_MIN', 'NEW_RATIO_PREV_AMT_CREDIT_MAX', 'PREV_CHANNEL_TYPE_Contact center_MEAN', 'APPROVED_AMT_DOWN_PAYMENT_MIN', 'ACTIVE_AMT_ANNUITY_MEAN', 'NEW_RATIO_PREV_AMT_GOODS_PRICE_MIN', 'PREV_CHANNEL_TYPE_AP+ (Cash loan)_MEAN', 'PREV_WEEKDAY_APPR_PROCESS_START_SUNDAY_MEAN', 'NEW_RATIO_BURO_MONTHS_BALANCE_SIZE_SUM', 'PREV_PRODUCT_COMBINATION_POS mobile with interest_MEAN', 'NEW_RATIO_PREV_APP_CREDIT_PERC_MIN', 'ACTIVE_AMT_ANNUITY_MAX', 'NONLIVINGAREA_AVG', 'NEW_RATIO_PREV_APP_CREDIT_PERC_VAR', 'NONLIVINGAREA_MODE', 'NEW_INC_BY_ORG', 'OBS_30_CNT_SOCIAL_CIRCLE', 'LANDAREA_MEDI', 'NEW_RATIO_BURO_MONTHS_BALANCE_MIN_MIN', 'PREV_AMT_DOWN_PAYMENT_MIN', 'POS_NAME_CONTRACT_STATUS_Signed_MEAN', 'PREV_HOUR_APPR_PROCESS_START_MIN', 'CC_AMT_DRAWINGS_ATM_CURRENT_VAR', 'PREV_PRODUCT_COMBINATION_POS industry with interest_MEAN', 'CC_AMT_CREDIT_LIMIT_ACTUAL_VAR', 'NEW_RATIO_BURO_MONTHS_BALANCE_SIZE_MEAN', 'PREV_NAME_SELLER_INDUSTRY_XNA_MEAN', 'NEW_RATIO_PREV_AMT_APPLICATION_MEAN', 'BURO_AMT_CREDIT_SUM_LIMIT_SUM', 'NEW_RATIO_PREV_AMT_APPLICATION_MIN', 'PREV_NAME_CONTRACT_TYPE_Cash loans_MEAN', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: middle_MEAN', 'NEW_RATIO_PREV_AMT_GOODS_PRICE_MAX', 'REFUSED_AMT_ANNUITY_MAX', 'PREV_NAME_GOODS_CATEGORY_Audio/Video_MEAN', 'CC_AMT_DRAWINGS_ATM_CURRENT_SUM', 'CLOSED_AMT_ANNUITY_MEAN', 'PREV_NAME_GOODS_CATEGORY_Computers_MEAN', 'REFUSED_AMT_ANNUITY_MEAN', 'PREV_PRODUCT_COMBINATION_Cash_MEAN', 'REFUSED_CNT_PAYMENT_MEAN', 'PREV_NAME_PORTFOLIO_XNA_MEAN', 'CC_AMT_DRAWINGS_ATM_CURRENT_MAX', 'CC_AMT_PAYMENT_CURRENT_MAX', 'PREV_NAME_GOODS_CATEGORY_Consumer Electronics_MEAN', 'COMMONAREA_MEDI', 'BASEMENTAREA_MEDI', 'BURO_MONTHS_BALANCE_MIN_MIN', 'REFUSED_AMT_GOODS_PRICE_MIN', 'PREV_NAME_GOODS_CATEGORY_Furniture_MEAN', 'COMMONAREA_MODE', 'NEW_RATIO_BURO_AMT_CREDIT_MAX_OVERDUE_MEAN', 'ENTRANCES_AVG', 'PREV_CODE_REJECT_REASON_HC_MEAN', 'REFUSED_AMT_GOODS_PRICE_MEAN', 'COMMONAREA_AVG', 'PREV_NAME_TYPE_SUITE_Spouse, partner_MEAN', 'PREV_NAME_CONTRACT_TYPE_Revolving loans_MEAN', 'CC_CNT_DRAWINGS_POS_CURRENT_MEAN', 'CC_AMT_PAYMENT_CURRENT_MIN', 'REFUSED_APP_CREDIT_PERC_MAX', 'LIVINGAPARTMENTS_AVG', 'POS_SK_DPD_MAX', 'CC_AMT_DRAWINGS_CURRENT_MEAN', 'ACTIVE_MONTHS_BALANCE_MIN_MIN', 'YEARS_BUILD_MODE', 'NONLIVINGAREA_MEDI', 'REFUSED_AMT_APPLICATION_MIN', 'CC_AMT_DRAWINGS_CURRENT_VAR', 'CLOSED_MONTHS_BALANCE_MIN_MIN', 'NEW_RATIO_PREV_AMT_APPLICATION_MAX', 'LIVINGAPARTMENTS_MODE', 'FLOORSMAX_AVG', 'CC_CNT_DRAWINGS_POS_CURRENT_VAR', 'NEW_RATIO_PREV_AMT_CREDIT_MEAN', 'CC_AMT_BALANCE_VAR', 'CC_AMT_DRAWINGS_CURRENT_SUM', 'CC_CNT_DRAWINGS_CURRENT_SUM', 'REFUSED_CNT_PAYMENT_SUM', 'CC_AMT_PAYMENT_TOTAL_CURRENT_VAR', 'PREV_AMT_GOODS_PRICE_MAX', 'YEARS_BUILD_AVG', 'PREV_PRODUCT_COMBINATION_Card Street_MEAN', 'LIVINGAPARTMENTS_MEDI', 'REFUSED_AMT_APPLICATION_MAX', 'CC_CNT_DRAWINGS_ATM_CURRENT_SUM', 'NONLIVINGAPARTMENTS_AVG', 'PREV_NAME_GOODS_CATEGORY_Photo / Cinema Equipment_MEAN', 'REFUSED_AMT_CREDIT_MAX', 'NEW_LIVE_IND_KURT', 'CC_AMT_DRAWINGS_POS_CURRENT_MAX', 'PREV_PRODUCT_COMBINATION_Card X-Sell_MEAN', 'REFUSED_AMT_CREDIT_MEAN', 'CC_AMT_INST_MIN_REGULARITY_SUM', 'NEW_RATIO_BURO_AMT_ANNUITY_MEAN', 'CC_AMT_PAYMENT_TOTAL_CURRENT_MAX', 'CC_AMT_DRAWINGS_CURRENT_MAX', 'PREV_PRODUCT_COMBINATION_Cash Street: middle_MEAN', 'CC_AMT_DRAWINGS_POS_CURRENT_VAR', 'CC_CNT_INSTALMENT_MATURE_CUM_VAR', 'PREV_CHANNEL_TYPE_Regional / Local_MEAN', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MIN', 'REFUSED_AMT_APPLICATION_MEAN', 'REFUSED_HOUR_APPR_PROCESS_START_MAX', 'ENTRANCES_MODE', 'CC_AMT_RECEIVABLE_PRINCIPAL_VAR', 'FLOORSMIN_AVG', 'PREV_NAME_SELLER_INDUSTRY_Furniture_MEAN', 'CC_AMT_INST_MIN_REGULARITY_MEAN', 'AMT_REQ_CREDIT_BUREAU_MON', 'CC_CNT_INSTALMENT_MATURE_CUM_MEAN', 'YEARS_BUILD_MEDI', 'REFUSED_AMT_GOODS_PRICE_MAX', 'PREV_PRODUCT_COMBINATION_POS household without interest_MEAN', 'NEW_RATIO_BURO_AMT_ANNUITY_MAX', 'ACTIVE_MONTHS_BALANCE_MAX_MAX', 'ELEVATORS_AVG', 'NEW_LIVE_IND_SUM', 'CC_AMT_INST_MIN_REGULARITY_MAX', 'CNT_FAM_MEMBERS', 'CC_CNT_INSTALMENT_MATURE_CUM_SUM', 'CC_MONTHS_BALANCE_SUM', 'FLOORSMIN_MODE', 'CLOSED_MONTHS_BALANCE_MAX_MAX', 'CC_AMT_CREDIT_LIMIT_ACTUAL_MAX', 'CC_MONTHS_BALANCE_VAR', 'CC_MONTHS_BALANCE_MEAN', 'CC_NAME_CONTRACT_STATUS_Active_SUM', 'FLOORSMIN_MEDI', 'PREV_NAME_CASH_LOAN_PURPOSE_Repairs_MEAN', 'BURO_STATUS_2_MEAN_MEAN', 'PREV_PRODUCT_COMBINATION_POS mobile without interest_MEAN', 'CC_NAME_CONTRACT_STATUS_Active_VAR', 'FLAG_OWN_REALTY', 'NONLIVINGAPARTMENTS_MEDI', 'FLOORSMAX_MODE', 'FLOORSMAX_MEDI', 'CLOSED_AMT_CREDIT_SUM_LIMIT_MEAN', 'CC_CNT_INSTALMENT_MATURE_CUM_MAX', 'CC_NAME_CONTRACT_STATUS_Active_MEAN', 'AMT_REQ_CREDIT_BUREAU_WEEK', 'ELEVATORS_MODE', 'PREV_NAME_CASH_LOAN_PURPOSE_XAP_MEAN', 'ELEVATORS_MEDI', 'NAME_TYPE_SUITE_Unaccompanied', 'BURO_MONTHS_BALANCE_MAX_MAX', 'WEEKDAY_APPR_PROCESS_START_THURSDAY', 'CC_MONTHS_BALANCE_MIN', 'CC_COUNT', 'CC_MONTHS_BALANCE_MAX', 'CC_NAME_CONTRACT_STATUS_Completed_MEAN', 'NAME_TYPE_SUITE_Family', 'FLAG_EMAIL', 'CC_CNT_INSTALMENT_MATURE_CUM_MIN', 'CC_NAME_CONTRACT_STATUS_Completed_SUM', 'NEW_RATIO_BURO_MONTHS_BALANCE_MAX_MAX', 'BURO_CNT_CREDIT_PROLONG_SUM', 'NEW_DOC_IND_AVG',]
# FEATURE_GRAVEYARD = list(set(FEATURE_GRAVEYARD) - set(REVIVE_FEATURES))
...
def application_train_test(nan_as_category = False):
    ...
    # df['NEW_DOC_IND_STD'] = df[docs].std(axis=1) # ver12.1
    ...
    df['NEW_CREDIT_TO_INCOME_RATIO'] = df['AMT_CREDIT'] / df['AMT_INCOME_TOTAL'] # ver12.1
    ...
    if not DEBUG:
        df = group_target_by_cols(df, AGG_RECIPE)
...
def selected_val_lightgbm(df, stratified = False, seed = int(time.time())):
    # Divide in training/validation and test data
    train_df = df[df['TARGET'].notnull()]
    test_df = df[df['TARGET'].isnull()]
    print("Starting LightGBM. Train shape: {}, test shape: {}".format(train_df.shape, test_df.shape))
    ...
    # Create arrays and dataframes to store results
    feature_importance_df = pd.DataFrame()
    feats = [f for f in train_df.columns if f not in ['TARGET','SK_ID_CURR','SK_ID_BUREAU','SK_ID_PREV','index']] # to do: include "istest" feature
    
    if TEST_NULL_HYPO:
        train_df['TARGET'] = train_df['TARGET'].copy().sample(frac=1.0).values

    train_df = train_df.merge(pd.read_csv('../util/istest_pred/istest_pred.csv'), how='left', on='SK_ID_CURR')
    select_val_data_threshold = train_df.istest.nlargest(int(train_df.shape[0] * VAL_DATA_RATE)).iloc[-1]
    print('Threshold of \'istest\' to select validation data = %.6f' %select_val_data_threshold)

    val_data_mask = (train_df['istest'] >= select_val_data_threshold)
    train_x, train_y = train_df.loc[~val_data_mask,feats], train_df.loc[~val_data_mask,'TARGET']
    valid_x, valid_y = train_df.loc[val_data_mask,feats], train_df.loc[val_data_mask,'TARGET']
    ...
    train_preds = clf.predict_proba(train_x, num_iteration=clf.best_iteration_)[:, 1]
    test_preds = clf.predict_proba(test_df[feats], num_iteration=clf.best_iteration_)[:, 1]

    feature_importance_df = pd.DataFrame()
    feature_importance_df["feature"] = feats
    feature_importance_df["importance"] = clf.feature_importances_

    print('---------------------------------------\nTrain AUC score %.6f' % roc_auc_score(train_y, train_preds))
    roc_auc = roc_auc_score(valid_y, valid_preds)
    print('Val AUC score %.6f\n---------------------------------------' % roc_auc)
    # Write submission file and plot feature importance
    ...
    return feature_importance_df, roc_auc
...
def main():
    ...
    with timer("Run LightGBM with kfold"):
        ...
        for i in range(ITERATION):
            print('Iteration %i' %i)
            if USE_SELECTED_VAL:
                iter_feat_imp, over_folds_val_auc = selected_val_lightgbm(df, seed = SEED)
            else:
