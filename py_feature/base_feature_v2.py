...
def main():
    ...
    with timer("Process credit card balance"):
        ...
        del cc
        gc.collect()
    with timer("Process base_featurs_v2"):
        print(df.shape)
        ...
        print('Final output : {}'.format(df.shape))
        gc.collect()
    ...
    df.to_hdf(os.path.join(output_path, 'base_featurs_v2.h5'), 'base_featurs_v2')

if __name__ == "__main__":
    with timer("base features v2 run"):
        main()
