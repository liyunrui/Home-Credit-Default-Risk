...
# Parameters from Tilii kernel: https://www.kaggle.com/kailex/tidy-xgb-all-tables-0-796/code
def kfold_xgb(df, num_folds, stratified = False, seed = int(time.time())):
    ...
    for n_fold, (train_idx, valid_idx) in enumerate(folds.split(train_df[feats], train_df['TARGET'])):
        ...
        train_preds[train_idx] += clf.predict_proba(train_x)[:, 1] / folds.n_splits
...
def main():
    ...
    with timer("Run LightGBM with kfold"):
        ...
        for i in range(ITERATION):
            print('Iteration %i' %i)    
            iter_feat_imp, over_folds_val_auc = kfold_xgb(df, num_folds = NUM_FOLDS, stratified = STRATIFIED, seed = SEED)
